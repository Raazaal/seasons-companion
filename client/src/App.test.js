  ...
  it("applies the self player's color as a CSS custom property once joined", async () => {
    ...
    createGameStore.mockReturnValueOnce({
      state: writable({
        ...
        activePlayerId: "p1",
        turnOrder: ["p1"],
        players: [{ id: "p1", name: "Alice", color: "red", score: 0 }],
        history: [],
      }),
  ...
  it("sends START_GAME once at least 2 players have joined", async () => {
    ...
    createGameStore.mockReturnValueOnce({
      state: writable({
        ...
        turnOrder: [],
        players: [
          { id: "p1", name: "Alice", color: "red", score: 0 },
          { id: "p2", name: "Bob", color: "blue", score: 0 },
        ],
        history: [],
      }),
      selfPlayerId: writable("p1"),
  ...
  it("shows final scores and sends NEW_GAME after confirmation once the game has ended", async () => {
    ...
    createGameStore.mockReturnValueOnce({
      state: writable({
        ...
        turnOrder: ["p1", "p2"],
        players: [
          { id: "p1", name: "Alice", color: "red", score: 12 },
          { id: "p2", name: "Bob", color: "blue", score: 9 },
        ],
        history: [],
      }),
      selfPlayerId: writable("p1"),
